...
<html>
  ...
  <body>
    <h1>QUESTIONNAIRE POUR EVALUER LA NOTORIETE DES ENTREPRISES PARTICIPANTS AU CONCOURS "MEILLEURES ENTREPRISES DE L'ANNEE"</h1>
		...
		<h2><u>Première catégorie : Les entreprises ayant moins de 10 salariés</u></h2>
      ...
      <div class ="container-fluid container question">
        ...
        <div class = " checkboxList" id="droite">
          <div class="check">
            ...
            <div class="CHECK_BOX">
              first1_11<input type = "radio" class="radio" name="radio1Q1" value="first1_11">
              second1_12<input type = "radio" class="radio" name="radio2Q1" value="second1_12">
              third1_13<input type = "radio" class="radio" name="radio3Q1" value="third1_13">
            </div>
            <div class="CHECK_BOX">
              first1_21<input type = "radio" class="radio" name="radio1Q1" value="first1_21">
              second1_22<input type = "radio" class="radio" name="radio2Q1" value="second1_22">
              third1_23<input type = "radio" class="radio" name="radio3Q1" value="third1_23">
            </div>
            <div class="CHECK_BOX">
              first1_31<input type = "radio" class="radio" name="radio1Q1" value="first1_31">
              second1_32<input type = "radio" class="radio" name="radio2Q1" value="second1_32">
              second1_32<input type = "radio" class="radio" name="radio3Q1" value="third1_33">
            </div>
            <div class="CHECK_BOX">
    ...
    <div class = " checkboxList" id="droite">
      <div class="check">
        ...
        <div class="CHECK_BOX">
          first5_11<input type = "radio" class="radio" name="radio1Q1" value="first5_11">
          second5_12<input type = "radio" class="radio" name="radio2Q1" value="second5_12">
          third5_13<input type = "radio" class="radio" name="radio3Q1" value="third5_13">
        </div>
        <div class="CHECK_BOX">
        ...
        <div class="CHECK_BOX">
          ...
          <input type = "radio" class="radio" name="radio2Q1" value="second552">
    ...
    <!--<form method="post" action="suivant.php">-->
      <?php
        include 'suivant.php';
      ?>
      <input type="submit" name="btn_suivant" value="Suivant" class="suivant">
