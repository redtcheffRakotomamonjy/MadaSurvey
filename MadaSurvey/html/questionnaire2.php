...
<html>
  ...
  <body>
    <h1>QUESTIONNAIRE POUR EVALUER LA NOTORIETE DES ENTREPRISES PARTICIPANTS AU CONCOURS "MEILLEURES ENTREPRISES DE L'ANNEE"</h1>
		...
		<h2><u>Deuxième catégorie : Les entreprises ayant moins de 20 salariés</u></h2>
      ...
      <div class ="container-fluid container question">
        <div class = "container-fluid liste" id="gauche">
          ...
          <h6>Shoprite Madagascar</h6>
          <h6>Leader Price Madagascar</h6>
          <h6>First Immo</h6>
          <h6>Holcim Madagasacar</h6>
          <h6>Madagascar Automobile</h6>
        </div>
    ...
    <form method="post" action="suivant2.php">
      <?php
        include 'suivant2.php';
      ?>
